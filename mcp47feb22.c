...
static void _ReadEpAddr(DAC_TypeDef dac, uint8_t REG, unsigned char buffer[5]);
static void _ReadAddr(DAC_TypeDef dac, uint8_t REG, unsigned char buffer[5]);
static void _FastWrite(DAC_TypeDef dac, uint8_t REG, uint16_t DATA);
static void _WriteAddr(DAC_TypeDef dac, uint8_t REG, uint8_t data);
